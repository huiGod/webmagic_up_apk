...
public class RsyncRingFailCore {
	...
	public static boolean multiUpload(String download_uuid){
		...
		String sql ="select * from ring where status = 12 limit ?,?";
